                ...
                switch (item.Id_nb)
                {
                    ...
                    case "token_many":
...

                        {
                            ...
                            player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "You are already level 40!"), eChatType.CT_System, eChatLoc.CL_PopupWindow);
                        ...
                        if (player.Level >= 1 && player.Level <=4)
                           ...
                           amountz = item.Count * 80;

                        if (player.Level >= 5 && player.Level <= 9)

                            amountz = item.Count * 1560;

                        if (player.Level >= 10 && player.Level <=19)

                            amountz = item.Count * 55850;

                        if (player.Level >= 20 && player.Level <= 34)

                            amountz = item.Count * 2161277;

                        if (player.Level >= 35 && player.Level <= 39)

                            amountz = item.Count * 16513537;
