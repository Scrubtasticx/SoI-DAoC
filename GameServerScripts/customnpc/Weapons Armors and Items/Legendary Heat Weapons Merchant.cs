...
{
    [NPCGuildScript("Heat Weapons")]
    public class LegendaryHeatWeapons : GameBountyMerchant
    {
        #region Constructor

        public LegendaryHeatWeapons() : base()
        {
        ...
        public override bool AddToWorld()
        {
            ...
            Name = "Burning Legendaries";
            GuildName = "Heat Weapons";
            Model = 1642;
            Size = 50;
            Level = 50;
            ...
            //Realm = 2;
            Flags |= eFlags.PEACE;
            TradeItems = new MerchantTradeItems("LegendaryHeatWeapons");
