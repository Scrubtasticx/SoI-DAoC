// Script made by Overdriven
// Editted by Leroy to add cata class support & removed the jewelry, cloak, and horse (for my server)
...
{
	public class EquipmentNPC : GameNPC
	{
		public EquipmentNPC()
			: base()
		{
		...
		private static ItemTemplate Sanctum_Test_Ring = null;
		...
		public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
		{
            ...
            item = new ItemTemplate();
            item.Id_nb = "HereticEpicBoots";
            item.Name = "Boots of Fanatical Renegade";
            item.Level = 51;
            item.Item_Type = (int)eInventorySlot.FeetArmor;
            item.Model = 143;
            item.IsDropable = true;
            ...
            item.Bonus4 = 10;
            item.Bonus4Type = (int)eResist.Energy;
            HereticEpicBoots = item;

            item = new ItemTemplate();
            item.Id_nb = "HereticEpicHelm";
            item.Name = "Crown of Fanatical Renegade";
            item.Level = 51;
            item.Item_Type = (int)eInventorySlot.HeadArmor;
            item.Model = 511;
            item.IsDropable = true;
            ...
            item.Bonus4 = 8;
            item.Bonus4Type = (int)eResist.Thrust;
            HereticEpicHelm = item;

            item = new ItemTemplate();
            item.Id_nb = "HereticEpicGloves";
            item.Name = "Gloves of Fanatical Renegade";
            item.Level = 51;
            item.Item_Type = (int)eInventorySlot.HandsArmor;
            item.Model = 142;
            item.IsDropable = true;
            ...
            item.Bonus4 = 8;
            item.Bonus4Type = (int)eResist.Crush;
            HereticEpicGloves = item;

            item = new ItemTemplate();
            item.Id_nb = "HereticEpicVest";
            item.Name = "Robe of Fanatical Renegade";
            item.Level = 51;
            item.Item_Type = (int)eInventorySlot.TorsoArmor;
            item.Model = 2921;
            item.IsDropable = true;
            ...
            item.Bonus4 = 6;
            item.Bonus4Type = (int)eResist.Thrust;
            HereticEpicVest = item;

            item = new ItemTemplate();
            item.Id_nb = "HereticEpicLegs";
            item.Name = "Pants of Fanatical Renegade";
            item.Level = 51;
            item.Item_Type = (int)eInventorySlot.LegsArmor;
            item.Model = 140;
            item.IsDropable = true;
            ...
            item.Bonus4 = 8;
            item.Bonus4Type = (int)eResist.Slash;
            HereticEpicLegs = item;

            item = new ItemTemplate();
            item.Id_nb = "HereticEpicArms";
            item.Name = "Sleeves of Fanatical Renegade";
            item.Level = 51;
            item.Item_Type = (int)eInventorySlot.ArmsArmor;
            item.Model = 141;
            item.IsDropable = true;
            ...
            item.Bonus4 = 4;
            item.Bonus4Type = (int)eProperty.Skill_Rejuvenation;
            HereticEpicArms = item;

            #endregion Heretic Epic
            ...
            #region Valkyrie Epic
            item = new ItemTemplate();
            item.Id_nb = "ValkyrieEpicBoots";
            item.Name = "Guiding Spirit Boots";
            item.Level = 51;
            item.Item_Type = (int)eInventorySlot.FeetArmor;
            item.Model = 2932;
            item.IsDropable = true;
            ...
            item.Bonus4 = 8;
            item.Bonus4Type = (int)eResist.Matter;
            ValkyrieEpicBoots = item;

            item = new ItemTemplate();
            item.Id_nb = "ValkyrieEpicHelm";
            item.Name = "Guiding Spirit Circlet";
            item.Level = 51;
            item.Item_Type = (int)eInventorySlot.HeadArmor;
            item.Model = 832;
            item.IsDropable = true;
            ...
            item.Durability = 50000;
            item.Bonus1 = 4;
            item.Bonus1Type = (int)eProperty.Skill_OdinsWill;
            item.Bonus2 = 18;
            item.Bonus2Type = (int)eStat.CON;
            item.Bonus3 = 4;
            item.Bonus3Type = (int)eResist.Spirit;
            item.Bonus4 = 6;
            item.Bonus4Type = (int)eProperty.PowerRegenerationRate;
            ValkyrieEpicHelm = item;

            item = new ItemTemplate();
            item.Id_nb = "ValkyrieEpicGloves";
            item.Name = "Guiding Spirit Gloves";
            item.Level = 51;
            item.Item_Type = (int)eInventorySlot.HandsArmor;
            item.Model = 2931;
            item.IsDropable = true;
            ...
            item.Bonus1Type = (int)eProperty.Skill_Sword;
            item.Bonus2 = 3;
            item.Bonus2Type = (int)eProperty.Skill_Spear;
            item.Bonus3 = 3;
            item.Bonus3Type = (int)eProperty.Skill_Mending;
            item.Bonus4 = 19;
            item.Bonus4Type = (int)eStat.STR;
            ValkyrieEpicGloves = item;

            item = new ItemTemplate();
            item.Id_nb = "ValkyrieEpicVest";
            item.Name = "Guiding Spirit Hauberk";
            item.Level = 51;
            item.Item_Type = (int)eInventorySlot.TorsoArmor;
            item.Model = 2928;
            item.IsDropable = true;
            ...
            item.Bonus4 = 30;
            item.Bonus4Type = (int)eProperty.MaxHealth;
            ValkyrieEpicVest = item;

            item = new ItemTemplate();
            item.Id_nb = "ValkyrieEpicLegs";
            item.Name = "Guiding Spirit Legs";
            item.Level = 51;
            item.Item_Type = (int)eInventorySlot.LegsArmor;
            item.Model = 2929;
            item.IsDropable = true;
            ...
            item.Bonus4 = 8;
            item.Bonus4Type = (int)eResist.Heat;
            ValkyrieEpicLegs = item;

            item = new ItemTemplate();
            item.Id_nb = "ValkyrieEpicArms";
            item.Name = "Guiding Spirit Sleeves";
            item.Level = 51;
            item.Item_Type = (int)eInventorySlot.ArmsArmor;
            item.Model = 2930;
            item.IsDropable = true;
            ...
            item.Bonus4 = 8;
            item.Bonus4Type = (int)eResist.Body;
            ValkyrieEpicArms = item;

            #endregion Valkyrie Epic
            #region Warlock Epic

            item = new ItemTemplate();
            item.Id_nb = "WarlockEpicBoots";
            item.Name = "Entrancing Mayhem Boots";
            item.Level = 51;
            item.Item_Type = (int)eInventorySlot.FeetArmor;
            item.Model = 2937;
            item.IsDropable = true;
            ...
            item.Bonus4 = 10;
            item.Bonus4Type = (int)eResist.Heat;
            WarlockEpicBoots = item;

            item = new ItemTemplate();
            item.Id_nb = "WarlockEpicHelm";
            item.Name = "Entrancing Mayhem Cap";
            item.Level = 51;
            item.Item_Type = (int)eInventorySlot.HeadArmor;
            item.Model = 825;
            item.IsDropable = true;
            ...
            item.Durability = 50000;
            item.Bonus1 = 4;
            item.Bonus1Type = (int)eProperty.Focus_Hexing;
            item.Bonus2 = 4;
            item.Bonus2Type = (int)eProperty.Focus_Cursing;
            item.Bonus3 = 13;
            item.Bonus3Type = (int)eStat.PIE;
            item.Bonus4 = 4;
            item.Bonus4Type = (int)eProperty.PowerRegenerationRate;
            WarlockEpicHelm = item;

            item = new ItemTemplate();
            item.Id_nb = "WarlockEpicGloves";
            item.Name = "Entrancing Mayhem Gloves ";
            item.Level = 51;
            item.Item_Type = (int)eInventorySlot.HandsArmor;
            item.Model = 2936;
            item.IsDropable = true;
            ...
            item.Durability = 50000;
            item.Bonus1 = 4;
            item.Bonus1Type = (int)eProperty.Focus_Witchcraft;
            item.Bonus2 = 13;
            item.Bonus2Type = (int)eStat.DEX;
            item.Bonus3 = 12;
            item.Bonus3Type = (int)eStat.PIE;
            item.Bonus4 = 6;
            item.Bonus4Type = (int)eProperty.PowerRegenerationRate;
            WarlockEpicGloves = item;

            item = new ItemTemplate();
            item.Id_nb = "WarlockEpicVest";
            item.Name = "Entrancing Mayhem Vest";
            item.Level = 51;
            item.Item_Type = (int)eInventorySlot.TorsoArmor;
            item.Model = 2933;
            item.IsDropable = true;
            ...
            item.Bonus4 = 24;
            item.Bonus4Type = (int)eProperty.MaxHealth;
            WarlockEpicVest = item;

            item = new ItemTemplate();
            item.Id_nb = "WarlockEpicLegs";
            item.Name = "Entrancing Mayhem Pants";
            item.Level = 51;
            item.Item_Type = (int)eInventorySlot.LegsArmor;
            item.Model = 2934;
            item.IsDropable = true;
            ...
            item.Bonus4 = 24;
            item.Bonus4Type = (int)eProperty.MaxHealth;
            WarlockEpicLegs = item;

            item = new ItemTemplate();
            item.Id_nb = "WarlockEpicArms";
            item.Name = "Entrancing Mayhem Sleeves";
            item.Level = 51;
            item.Item_Type = (int)eInventorySlot.ArmsArmor;
            item.Model = 2935;
            item.IsDropable = true;
            ...
            item.Bonus4 = 8;
            item.Bonus4Type = (int)eResist.Heat;
            WarlockEpicArms = item;

            #endregion Warlock Epic
            ...
            item.Name = "Valhalla Touched Cap";
            item.Level = 51;
            item.Item_Type = (int)eInventorySlot.HeadArmor;
            item.Model = 1298; //NEED TO WORK ON..
            item.IsDropable = true;
            ...
            item.Name = "Valhalla Touched Vest";
            item.Level = 51;
            item.Item_Type = (int)eInventorySlot.TorsoArmor;
            item.Model = 744;
            item.IsDropable = true;
            ...
            item.Name = "Valhalla Touched Pants";
            item.Level = 51;
            item.Item_Type = (int)eInventorySlot.LegsArmor;
            item.Model = 379;
            item.IsDropable = true;
			...
			#region Bainshee Epic
			item = new ItemTemplate();
            item.Id_nb = "BainsheeEpicBoots";
            item.Name = "Boots of the Keening Spirit";
			item.Level = 51;
			item.Item_Type = (int)eInventorySlot.FeetArmor;
			item.Model = 2952;
			item.IsDropable = true;
			...
			item.Bonus4 = 21;
			item.Bonus4Type = (int)eProperty.MaxHealth;
            BainsheeEpicBoots = item;

			item = new ItemTemplate();
            item.Id_nb = "BainsheeEpicHelm";
            item.Name = "Wreath of the Keening Spirit";
			item.Level = 51;
			item.Item_Type = (int)eInventorySlot.HeadArmor;
			item.Model = 1298; //NEED TO WORK ON..
			item.IsDropable = true;
			...
			item.Bonus2Type = (int)eResist.Spirit;
			item.Bonus3 = 4;
			item.Bonus3Type = (int)eProperty.Focus_PhantasmalWail;
			item.Bonus4 = 19;
			item.Bonus4Type = (int)eStat.INT;
            BainsheeEpicHelm = item;

			item = new ItemTemplate();
            item.Id_nb = "BainsheeEpicGloves";
            item.Name = "Gloves of the Keening Spirit";
			item.Level = 51;
			item.Item_Type = (int)eInventorySlot.HandsArmor;
			item.Model = 2950;
			item.IsDropable = true;
			...
			item.Durability = 50000;
			item.Bonus1 = 4;
			item.Bonus1Type = (int)eProperty.Focus_SpectralForce;
			item.Bonus2 = 9;
			item.Bonus2Type = (int)eStat.DEX;
			item.Bonus3 = 4;
			item.Bonus3Type = (int)eProperty.PowerRegenerationRate;
			item.Bonus4 = 24;
			item.Bonus4Type = (int)eProperty.MaxHealth;
            BainsheeEpicGloves = item;

			item = new ItemTemplate();
            item.Id_nb = "BainsheeEpicVest";
            item.Name = "Robe of the Keening Spirit";
			item.Level = 51;
			item.Item_Type = (int)eInventorySlot.TorsoArmor;
			item.Model = 2922;
			item.IsDropable = true;
            ...
            BainsheeEpicVest = item;

			item = new ItemTemplate();
            item.Id_nb = "BainsheeEpicLegs";
            item.Name = "Pants of the Keening Spirit";
			item.Level = 51;
			item.Item_Type = (int)eInventorySlot.LegsArmor;
			item.Model = 2949;
			item.IsDropable = true;
			...
			item.Bonus4 = 16;
			item.Bonus4Type = (int)eStat.CON;
            BainsheeEpicLegs = item;

			item = new ItemTemplate();
            item.Id_nb = "BainsheeEpicArms";
			item.Name = "Sleeves of the Keening Spirit";
			item.Level = 51;
			item.Item_Type = (int)eInventorySlot.ArmsArmor;
			item.Model = 2948;
			item.IsDropable = true;
			...
			item.Durability = 50000;
			item.Bonus1 = 4;
			item.Bonus1Type = (int)eProperty.Focus_EtherealShriek;
			item.Bonus2 = 10;
			item.Bonus2Type = (int)eStat.DEX;
			item.Bonus3 = 10;
			item.Bonus3Type = (int)eStat.INT;
			item.Bonus4 = 27;
			item.Bonus4Type = (int)eProperty.MaxHealth;
            BainsheeEpicArms = item;
            #endregion Bainshee Epic
            #region Druid Epic
            item = new ItemTemplate();
            ...
            #region Nightshade Epic
            item = new ItemTemplate();
            item.Id_nb = "VampiirEpicBoots";
            item.Name = "Boots of Immortal Shadows";
            item.Level = 51;
            item.Item_Type = (int)eInventorySlot.FeetArmor;
            item.Model = 2927;
            item.IsDropable = true;
            ...
            item.Bonus4 = 24;
            item.Bonus4Type = (int)eProperty.MaxHealth;
            VampiirEpicBoots = item;

            item = new ItemTemplate();
            item.Id_nb = "VampiirEpicHelm";
            item.Name = "Wreath of Immortal Shadows";
            item.Level = 51;
            item.Item_Type = (int)eInventorySlot.HeadArmor;
            item.Model = 2926; //NEED TO WORK ON..
            item.IsDropable = true;
            item.IsPickable = true;
            item.DPS_AF = 102;
            item.SPD_ABS = 10;
            ...
            item.Bonus4 = 39;
            item.Bonus4Type = (int)eProperty.MaxHealth;
            VampiirEpicHelm = item;

            item = new ItemTemplate();
            item.Id_nb = "VampiirEpicGloves";
            item.Name = "Gloves of Immortal Shadows";
            item.Level = 51;
            item.Item_Type = (int)eInventorySlot.HandsArmor;
            item.Model = 2926;
            item.IsDropable = true;
            ...
            item.Durability = 50000;
            item.Bonus1 = 2;
            item.Bonus1Type = (int)eProperty.Skill_ShadowMastery;
            item.Bonus2 = 12;
            item.Bonus2Type = (int)eStat.DEX;
            item.Bonus3 = 13;
            item.Bonus3Type = (int)eStat.QUI;
            item.Bonus4 = 5;
            item.Bonus4Type = (int)eProperty.Skill_Dementia;
            VampiirEpicGloves = item;

            item = new ItemTemplate();
            item.Id_nb = "VampiirEpicVest";
            item.Name = "Vest of Immortal Shadows";
            item.Level = 51;
            item.Item_Type = (int)eInventorySlot.TorsoArmor;
            item.Model = 2923;
            item.IsDropable = true;
            ...
            item.Bonus3 = 30;
            item.Bonus3Type = (int)eProperty.MaxHealth;
            VampiirEpicVest = item;

            item = new ItemTemplate();
            item.Id_nb = "VampiirEpicLegs";
            item.Name = "Leggings of Immortal Shadows";
            item.Level = 51;
            item.Item_Type = (int)eInventorySlot.LegsArmor;
            item.Model = 2924;
            item.IsDropable = true;
            ...
            item.Bonus4 = 10;
            item.Bonus4Type = (int)eResist.Slash;
            VampiirEpicLegs = item;

            item = new ItemTemplate();
            item.Id_nb = "VampiirEpicArms";
            item.Name = "Sleeves of Immortal Shadows";
            item.Level = 51;
            item.Item_Type = (int)eInventorySlot.ArmsArmor;
            item.Model = 2925;
            item.IsDropable = true;
            ...
            item.Durability = 50000;
            item.Bonus1 = 4;
            item.Bonus1Type = (int)eProperty.Skill_VampiiricEmbrace;
            item.Bonus2 = 16;
            item.Bonus2Type = (int)eStat.CON;
            item.Bonus3 = 15;
            item.Bonus3Type = (int)eStat.DEX;
            item.Bonus4 = 6;
            item.Bonus4Type = (int)eResist.Cold;
            VampiirEpicArms = item;
            #endregion Vampiir Epic

			#endregion Armor

			#endregion Armor/Equip
		#endregion Armor/Equip
			if (log.IsInfoEnabled)
		...
		public override bool Interact(GamePlayer player)
		{
			...
			else SendReply(player, "Hello! " + player.Name + ", are you interested in some :\n\n [Weapons]? \n [Armor]?");
			InventoryItem generic0 = new InventoryItem();
                            ItemTemplate tgeneric0 = GameServer.Database.FindObjectByKey<ItemTemplate>("Sanctum_Test_Ring");
                            ...
                            player.Out.SendMessage("Here you are!", eChatType.CT_System, eChatLoc.CL_SystemWindow);
			return true;
		}
		...
		public override bool WhisperReceive(GameLiving source, string str)
		{
			...
			switch (str)
			{
				...
				case "Armor":
					{
						...
						#endregion Friar
                        #region Heretic
                        if (player.CharacterClass.ID == (byte)eCharacterClass.Heretic)
						{
                            GiveItem(player, HereticEpicBoots);
                            GiveItem(player, HereticEpicHelm);
                            GiveItem(player, HereticEpicGloves);
                            GiveItem(player, HereticEpicVest);
                            GiveItem(player, HereticEpicLegs);
							GiveItem(player, HereticEpicArms);
						...
						#endregion Savage
                        #region Valkyrie
                        if (player.CharacterClass.ID == (byte)eCharacterClass.Valkyrie)
                        {
                            GiveItem(player, ValkyrieEpicBoots);
                            GiveItem(player, ValkyrieEpicHelm);
                            GiveItem(player, ValkyrieEpicGloves);
                            GiveItem(player, ValkyrieEpicVest);
                            GiveItem(player, ValkyrieEpicLegs);
                            GiveItem(player, ValkyrieEpicArms);
							
                        }
                        #endregion Valkyrie
                        #region Warlock
                        if (player.CharacterClass.ID == (byte)eCharacterClass.Warlock)
                        {
                            GiveItem(player, WarlockEpicBoots);
                            GiveItem(player, WarlockEpicHelm);
                            GiveItem(player, WarlockEpicGloves);
                            GiveItem(player, WarlockEpicVest);
                            GiveItem(player, WarlockEpicLegs);
                            GiveItem(player, WarlockEpicArms);
                        ...
                        #endregion Mentalist
                        #region Bainshee
                        if (player.CharacterClass.ID == (byte)eCharacterClass.Bainshee)
                        {
                            GiveItem(player, BainsheeEpicBoots);
                            GiveItem(player, BainsheeEpicHelm);
                            GiveItem(player, BainsheeEpicGloves);
                            GiveItem(player, BainsheeEpicVest);
                            GiveItem(player, BainsheeEpicLegs);
                            GiveItem(player, BainsheeEpicArms);
                        ...
                        #region Vampiir
                        if (player.CharacterClass.ID == (byte)eCharacterClass.Vampiir)
                        {
                            GiveItem(player, VampiirEpicBoots);
                            GiveItem(player, VampiirEpicHelm);
                            GiveItem(player, VampiirEpicGloves);
                            GiveItem(player, VampiirEpicVest);
                            GiveItem(player, VampiirEpicLegs);
                            GiveItem(player, VampiirEpicArms);
				...
				case "Weapons":
					{
                        ...
                        if (player.CharacterClass.ID == (byte)eCharacterClass.Valkyrie)
                        {
                            SendReply(player, "Would you like a [Sword], a [Midgard Thrust Spear], a [Midgard Slash Spear], a [Two Handed Sword], or a [Large Shield]?");
                        }
                        #endregion Valkyrie
                        #endregion Midgard
                        #region Hibernia
						...
						if (player.CharacterClass.ID == (byte)eCharacterClass.Hero)
						{
							SendReply(player, "Would you like a [Blade Weapon] a [Blunt Weapon] a [Large Blunt] a [Lage Blade] a [Offhand Pierce] a [Hibernian Blade Spear] a [Hibernian Pierce Spear] OR a [Large Shield]?");
						}
						#endregion Hero
						#region Champion
						if (player.CharacterClass.ID == (byte)eCharacterClass.Champion)
						{
                            SendReply(player, "Would you like a [Blade Weapon] a [Pierce Weapon] a [Blunt Weapon] a [Large Blunt] a [Large Blade] a [Hibernian Blade Spear] a [Hibernian Pierce Spear] OR a [Large Shield]?");
						}
						#endregion Champion
						#region Eldritch
						if (player.CharacterClass.ID == (byte)eCharacterClass.Eldritch)
                        ...
                        if (player.CharacterClass.ID == (byte)eCharacterClass.Vampiir)
                        {
                            SendReply(player, "Would you like a [Pierce Weapon]?");
                        }
                        #endregion Vampiir
                        #endregion Hibernia
                        break;
				...
				#endregion Sword
                #region Midgard Thrust Spear
                case "Midgard Thrust Spear":
                    {
                        GiveItem(player, MidgardThrustSpear);
                        break;
                    }
                #endregion Midgard Thrust Spear
