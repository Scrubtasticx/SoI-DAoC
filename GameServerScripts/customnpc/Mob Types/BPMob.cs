...
public class BPMob : GameNPC
{
...

    {
        ...
        int basebp = 0;
		if (Level >= 1 && Level <=10) { basebp = 10; }
		if (Level >= 11 && Level <=19) { basebp = 20; }
		if (Level >= 20 && Level <=29) { basebp = 30; }
		if (Level >= 30 && Level <=39) { basebp = 40; }
		if (Level >= 40 && Level <=44) { basebp = 50; }
        if (Level == 45) { basebp = 55; }
        if (Level == 46) { basebp = 60; }
        if (Level == 47) { basebp = 65; }
        if (Level == 48) { basebp = 70; }
        if (Level == 49) { basebp = 75; }
        if (Level == 50) { basebp = 80; }
        if (Level == 51) { basebp = 85; }
        if (Level == 52) { basebp = 90; }
        if (Level == 53) { basebp = 95; }
        if (Level == 54) { basebp = 100; }
        if (Level == 55) { basebp = 110; }
        if (Level >= 56) { basebp = 120; }
        if (Level >= 59) { basebp = 130; }
